                    ...
                    <div class="col-sm">
                        <div class="card">
	                        <div class="card-body">
                                <h4>Registrasi</h4>
                                (*) Required
                                <form action="<?= site_url('Admin/daftar_apotek/') ?>" method="post">
                                    <div class="form-row">    
                                        <div class="form-group col-md-4">
                                            <input id="nama_apotek" name="nama_apotek" placeholder="Nama Apotek*" class="form-control" type="text" required>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <input id="jalan" name="jalan" placeholder="Jalan" class="form-control" type="text">
                                        </div>
					                    <div class="form-row">
