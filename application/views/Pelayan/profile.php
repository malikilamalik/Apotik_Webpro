...
<html>
       ...
       <div class="container-flex" style="padding-bottom:100px; background-color: #124f67 !important;">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row"style="padding: 10px;">
                    <div class="col-md-1" ><a class="btn btn-warning" href="<?= base_url(); ?>Pelayan/edit_profile/<?= $user['user_id'] ?>" role="button">Edit</a></div>
                    <div class="col-md-1" id="btn_edit"><a class="btn btn-primary btn-edit-password" role="button">Ganti Password</a></div>
                </div>
            </div>
        </div>
        </div>
    ...
    $("#btn_update_password").on('click',function(){
        ...
        if(password_lama_input == password_lama){
            $.ajax({
                url: '<?php echo base_url(); ?>Pelayan/UpdatePassword',
                type: 'POST',
