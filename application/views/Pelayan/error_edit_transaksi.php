        ...
        <div class="gridContent-2t3OFU">
                <div class="row">
                    <div class="col-sm">
                        <div class="card">
	                        <div class="card-body">
                                <h4>Update Transaksi</h4>
                                <p style="color:red">(*) Required</p>
                                <h6 style="color:red">ID RESEP TIDAK DITEMUKAN!</h6>
                                <form action="<?= site_url('Pelayan/UpdateTransaksi/') ?>" method="POST">
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        <input id="id_transaksi" name="id_transaksi" class="form-control" type="text" value="<?php echo $transaksi['id_transaksi'] ?>" hidden>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        <input id="id_resep" name="id_resep" placeholder="ID Resep*" class="form-control" type="text" value="<?php echo $transaksi['id_resep'] ?>" required>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        <input id="harga" name="harga" placeholder="Harga Transaksi*" class="form-control" type="text" value="<?php echo $transaksi['harga'] ?>" required>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        <input id="status_transaksi" name="status_transaksi" placeholder="Status Transaksi*" class="form-control" type="text" value="<?php echo $transaksi['status_transaksi'] ?>" required>
                                    </div>
                                </div>
                                <div class="form-row">
